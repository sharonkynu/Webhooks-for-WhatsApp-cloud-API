...
// Get token and port from environment variables
...
// Route for the root path (http://localhost:3006/)
app.get('/', (req, res) => {
    const statusMessage = "Server is up and running!";  // Custom status message
    res.status(200).render('index', { statusMessage });  // Pass statusMessage to EJS
});
